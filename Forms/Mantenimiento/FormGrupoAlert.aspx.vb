    ...
    Protected Sub btnOK_Click(sender As Object, e As EventArgs)
        ...
        Try
            If (valor.Equals("0") Or valor.Equals("")) Then
                ...
                BD.spGrupoAlertaIngresar(tbGrupo.Text.ToUpper, tbDescripcion.Text.ToUpper, idUser, nmUser)
            ...
            Else
                ...
                BD.spGrupoAlertaActualizar(CInt(tbID.Text), tbGrupo.Text.ToUpper, tbDescripcion.Text.ToUpper, idUser, nmUser)
