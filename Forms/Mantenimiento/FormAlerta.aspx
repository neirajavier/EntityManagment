<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FormAlerta.aspx.vb" Inherits="ArtemisAdmin.FormAlerta" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function onSelectNode(s, e) {
            debugger;
            var visibleSelectedNode = s.GetVisibleSelectedNodeKeys();
            for (let i = 0; i < visibleSelectedNode.length; i++) {
                //console.log(visibleSelectedNode[i]);
                if (s.IsNodeSelected(visibleSelectedNode[i]) && visibleSelectedNode[i] != "3")
                    s.SelectNode("3", false);
            }
...
                                                                      Width="100%" CssClass="grid" EnableTheming="true" Theme="Moderno" OnPreRender="tlAsignacion_PreRender"
                                                        ...
                                                        <%--OnHtmlRowPrepared="tlAsignacion_HtmlRowPrepared"--%>
                                                        <Border BorderStyle="Solid"/>
                                                        <ClientSideEvents SelectionChanged="onSelectNode" />
...
                                                    </dxt:ASPxTreeList>
                                ...
                                <dx:LayoutGroup Caption="Notificar a" GroupBoxStyle-Caption-ForeColor="Black" GroupBoxDecoration="Box" 
                                    ...
                                    <Items>
                                        <dx:LayoutItem Caption="Celular" VerticalAlign="Middle" CaptionStyle-Font-Size="10" CaptionStyle-Font-Bold="true">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer>
                                                    <dx:ASPxTextBox ID="tbCelular" runat="server" Width="100%" ClientInstanceName="tbCelular"
                                                                    BorderBottom-BorderStyle="Outset" BorderLeft-BorderStyle="None" BorderRight-BorderStyle="None" BorderTop-BorderStyle="None"
                                                                    FocusedStyle-BorderBottom-BorderColor="Red" Font-Size="10"/>
                                                    <dx:ASPxLabel runat="server" Text="Escribir celular separados por comas(,)" ForeColor="Red" Font-Bold="true" Font-Size="7.5"/>
                                                </dx:LayoutItemNestedControlContainer>
                                            </LayoutItemNestedControlCollection>
                                        </dx:LayoutItem>
                                        <dx:LayoutItem Caption="Email" VerticalAlign="Middle" CaptionStyle-Font-Size="10" CaptionStyle-Font-Bold="true">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer>
