<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AsignarGrupoPtoS2.aspx.vb" Inherits="ArtemisAdmin.AsignarGrupoPtoS2" %>
                                ...
                                <dx:LayoutItem Caption="">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer>
                                            <dx:ASPxListBox ID="ListBoxGrupoSub2" runat="server" SelectionMode="CheckColumn" ClientInstanceName="ListBoxGrupoSub2" AutoPostBack="false"
                                                            EnableClientSideAPI="True" EnableSelectAll="true" EnableCallbackMode="true" Width="300" Height="300"
                                                            OnSelectedIndexChanged="ListBoxGrupoSub2_SelectedIndexChanged">
