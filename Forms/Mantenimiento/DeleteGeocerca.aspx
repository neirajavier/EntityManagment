<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="DeleteGeocerca.aspx.vb" Inherits="ArtemisAdmin.DeleteGeocerca" %>
...
<head runat="server">
    ...
    <style type="text/css">
        ...
        .centerText input { text-align: justify; }  
...
<body>
    <form id="form1" runat="server">
        <div>
            <dx:ASPxPanel ID="ASPxPanel" runat="server" DefaultButton="btOK">
                <PanelCollection>
                                ...
                                <dx:LayoutItem Caption=" ">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer>
                                            ...
                                            <dx:ASPxLabel ID="lbMessage" runat="server" ClientInstanceName="lbMessage" Font-Size="Medium" CssClass="centerText"/>
                                        </dx:LayoutItemNestedControlContainer>
                                    </LayoutItemNestedControlCollection>
                                </dx:LayoutItem>
