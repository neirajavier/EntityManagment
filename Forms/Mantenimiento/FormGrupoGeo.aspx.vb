    ...
    Protected Sub btnOK_Click(sender As Object, e As EventArgs)
        ...
        Try
            If (valor.Equals("0") Or valor.Equals("")) Then
                ...
                If BD.ExisteGrupoGeo(tbGrupo.Text.Trim, CInt(Session("IdUsuario"))) = 1 Then
                    message = "El grupo que desea ingresar ya existe"
                    Funciones.EjecutarFuncionJavascript(Me, "window.parent.showNotification2('" + message + "','A');")
                    Return
                End If

                BD.spGrupoGeocercaIngresar(tbGrupo.Text.ToUpper, tbDescripcion.Text.ToUpper, idUser, cbMostrar.Value.ToString)
            ...
            Else
                ...
                BD.spGrupoGeocercaActualizar(CInt(tbID.Text), tbGrupo.Text.ToUpper, tbDescripcion.Text.ToUpper, idUser, cbMostrar.Value.ToString)
