<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AsignarGrupo.aspx.vb" Inherits="ArtemisAdmin.AsignarGrupo" %>
                    ...
                    <dx:PanelContent runat="server">
                        <dx:ASPxFormLayout runat="server" Width="100%" Height="100%">
                            <Items>
                                    ...
                                    <LayoutItemNestedControlCollection>
                                        ...
                                        <dx:LayoutItemNestedControlContainer>
                                            <dx:ASPxListBox ID="ListBoxGrupoDet" runat="server" SelectionMode="CheckColumn" ClientInstanceName="ListBoxGrupoDet"
                                                            EnableClientSideAPI="True" EnableSelectAll="true" Width="300" Height="300"
                                ...
                                <dx:LayoutItem Caption="Etiqueta">
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer>
                                            <dx:ASPxTextBox ID="tbEtiqueta" runat="server" Width="100%" ClientInstanceName="tbEtiqueta"/>
                                        </dx:LayoutItemNestedControlContainer>
                                    </LayoutItemNestedControlCollection>
                                </dx:LayoutItem>
                                    ...
                                    <LayoutItemNestedControlCollection>
                                        <dx:LayoutItemNestedControlContainer>
                                            ...
                                            <%--<dx:ASPxButton ID="btnCancel" runat="server" Text="Cancelar" Width="80px" AutoPostBack="False"
                                                ...
                                                <ClientSideEvents Click="function(s,e){ window.parent.GrupoWindowHide4(); }" />
                                            </dx:ASPxButton>--%>
                                        </dx:LayoutItemNestedControlContainer>
                                    </LayoutItemNestedControlCollection>
                                </dx:LayoutItem>
